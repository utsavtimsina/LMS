...
if(isset($_POST['register'])){
    ...
    $chk_query = "SELECT * FROM lib_tbl WHERE `email`='$email' OR `empid`='$empid'";
    $chk_res =mysqli_query($conn,$chk_query);
    if(mysqli_num_rows($chk_res)<=0){

    $sql="INSERT INTO `lib_tbl`( `fname`, `mname`, `lname`, `email`, `password`, `empid`,`role`) VALUES ('$fname','$mname','$lname','$email','$password','$empid',$role)";
...
<head>
    ...
    <title>Add Librian</title>
</head>
<body>
<header>
        <div class="title">
            <h4>Librarian Registration</h4>
        </div>
    </header>
    ...
    <div class="content">
        ...
        ?>
            <div class="msg" id="impmsg">
                <i class="fa-solid fa-plus cross" onclick="location.href='addLibrarian.php'"></i>
