...
(2, 'C-Programming e1', '1BCACACS151', 1, 'CACS151', '1st', '2nd', 1, 1, 'KEC', 'Ramesh Singh', 200, 'a2', 2, 0, 2),
(3, 'Math I e1', '1BCACAMT104', 1, 'CAMT104', '1st', '1st', 1, 4, 'KEC', 'Aasish Shrestha', 450, 'a3', 0, 0, 0),
(7, 'Business Mathematics I e1', '1BBAMTH201', 2, 'MTH201', '1st', '1st', 1, 4, 'KEC', 'Rameshor Rai', 550, 'b1', 0, 0, 0),
(8, 'Macro Economics  e1', '1BBAECO202', 2, 'ECO202', '1st', '2nd', 1, 2, 'KEC', 'Ram Yadav', 235, 'c1', 0, 0, 0),
(9, 'Business Finance e1', '1BBAFIN201', 2, 'FIN201', '2nd', '3rd', 1, 2, 'KEC', 'Ramesh Singh', 500, 'd1', 0, 0, 0),
...
(17, '1BCACACS151', 1, '1BCACACS1511', 23434333, NULL, NULL, 'true', NULL),
...
(8, 'Aasish', '', 'Shrestha', 'aasish@gmail.com', 'student', '2022BCA3', 'aasish'),
...
--
ALTER TABLE `book_tbl`
  MODIFY `biid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `issue_tbl`
  MODIFY `txn_no` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
